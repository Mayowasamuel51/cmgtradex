        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    @endif
                    <div class="content">
                        <h3 style="color:white; text-shadow: 2px 2px 5px red;">{{$cat->title}}</h3>
                        <a href="{{route('product-cat',$cat->slug)}}" style="color:white; text-shadow: 2px 2px 5px red;">Discover Now</a>
                    </div>
                </div>
            </div>
            @endif
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{ route('product-detail', $product->slug) }}">
                                        ...
                                        @endphp
                                        <img src="{{ asset("./upload/images/".$photos[0]) }}" class="img-fluid shadow rounded product-image"
                                            alt="Product Image">
                                        @else
                                ...
                                <div class="product-img">
                                    <a href="{{route('product-detail',$product->slug)}}">
                                        ...
                                        <img src="{{ asset($photos[0]) }}" class="img-fluid zoom shadow rounded"
                                            ...
                                            alt="Product Image">
                                        @else
                                        <img src="{{ asset('backend/img/thumbnail-default.jpg') }}" class="img-fluid shadow rounded"
                                            style="max-width: 150px; height: auto; object-fit: cover; border: 3px solid #ddd; padding: 5px;"
                                            alt="Default Image">
                                        @endif
